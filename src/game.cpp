...
// Gets information about the feedback messages.
// Inputs: None
// Outputs:
//   - std::vector<std::string>: A vector containing information about the feedback messages.
...
// Inserts a new feedback message.
// Inputs:
//   - const std::string &feedback: The feedback message to insert.
// Outputs: None
...
// Gets the total productivity of all cities.
// Inputs: None
// Outputs:
//   - int: The total productivity of all cities.
...
// Inputs:
//   - Position dcursor: The amount to move the cursor by.
// Outputs: None
...
// Checks if two positions are within a specified range of each other.
// Inputs:
//   - Position p1: The first position.
//   - Position p2: The second position.
//   - int range: The range to check.
// Outputs:
//   - bool: True if the positions are within the range, false otherwise.
...
// Selects a missile.
// Outputs: Selected Missile. Throws error if no missile selected.
...
// Selects a city.
// Outputs: Selected City. Throws error if no city selected.
...
// Starts research on a tech node.
// Inputs: TechNode to research.
...
// Checks if research is complete and updates the tech tree.
...
// Finishes research on a tech node and applies its effects.
// Inputs: TechNode to finish research on.
...
// Hits a city with damage.
// Inputs: City to hit, Damage to inflict.
...
// Fixes a city, increasing its hitpoints.
...
// Builds a cruise missile in a city.
...
// Launches a cruise missile from a city.
void Game::launch_cruise(void)
{
    ...
    insert_feedback("Cruise Missile Launched"); e
    city.cruise_storage--;
}

// Builds a standard bomb.
...
// Checks if the iron curtain is active and deactivates it if its time is up.
...
// Activates the self-defense system.
